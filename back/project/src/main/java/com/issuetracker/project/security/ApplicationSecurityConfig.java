package com.issuetracker.project.security;

import com.google.common.collect.ImmutableList;
import com.issuetracker.project.jwt.JwtConfig;
import com.issuetracker.project.jwt.JwtTokenVerifier;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .cors()
                .and()
                .csrf().disable() //TODO: perhaps remove this
