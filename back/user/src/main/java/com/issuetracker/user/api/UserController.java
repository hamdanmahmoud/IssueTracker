...
public class UserController {
    ...
    @GetMapping
    public ResponseEntity<UserModel> getUserByMail(@RequestParam("mail") String mail){
    ...
    public ResponseEntity<UserModel> updateUserById(
            ...
            @Valid @NonNull @RequestBody UserEntity userEntity){
    ...
    public void uploadProfilePicture(
            @PathVariable("id") UUID id,
            @Valid @NonNull @RequestBody String file) {
    ...
    public void updateUserProfileById(
            @PathVariable("id") UUID id,
            @Valid @NonNull @RequestBody UserProfile userProfile){
        userService.updateUserProfileById(id, userProfile);
    }
